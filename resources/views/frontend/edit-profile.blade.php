    ...
    <form action="{{ route('profile.update') }}" method="POST" class="mt-8">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                class="w-full p-3 border rounded-md focus:outline-none focus:ring-2
            ...
            <div>
                ...
                <input type="password" name="password" id="password" class="w-full p-3 
            ...
            <div class="mt-6">
                <button type="submit" class="w-full bg-blue-500 text-white py-3 rounded-md
                 hover:bg-blue-600 transition">Update Profile</button>
            </div>
        </div>
    </form>
</div>
